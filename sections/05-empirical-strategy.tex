...
\end{equation}
로 정의한다. 여기서 $s$는 원시 역배당률 합의 역수다. 이 표현은 심플렉스
제약과 성분별 구간을 동시에 보존하며 선형 부등식으로 계산할 수 있다.
...
단위 부트스트랩 95\% 신뢰구간 하한이 0보다 클 때만 우위를 인정한다. 절대오차가 경제적으로
작다는 판정은 TV의 운영적 의미에 따라 $\tau_{\rm TV}=0.05$를 사전 기준으로
