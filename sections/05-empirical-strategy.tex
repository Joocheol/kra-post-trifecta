...
각 기준모형에도 같은 방식으로 TV의 하한과 인증 상한을 계산한다. 삼쌍승 타경주
기준의 donor가 상한 경주이면 donor의 $\mathcal P^T_{r'}$ 전체를 포함하며 점값으로
대체하지 않는다. 삼쌍승 주변가격이 기준보다 강건하게 우월하다는 판정은 보수적으로
...
\[
  ...
  =\underline{\operatorname{TV}}_{r,m,b}
   -\overline{\operatorname{TV}}^{\mathrm{out}}_{r,m,\mathrm{main}}
\]
