...
\]
을 사용한다. Panel A와 Panel B의 기준모형 우위는 각각
$\operatorname{median}_r(\Delta^A_{r,m,b})$와
$\operatorname{median}_r(\underline\Delta^B_{r,m,b})$의 경주 단위
부트스트랩 95\% 신뢰구간 하한이 0보다 클 때만 인정한다. 절대오차가 경제적으로
