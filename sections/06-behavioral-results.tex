...
\resizebox{0.88\textwidth}{!}{\input{tables/behavioral_model_comparison}}
\end{table}
...
수치오차 $2.3\times 10^{-16}$ 이내에서 일치하여, 곱셈적 가중함수의
축약 불변성이 예상대로 재현된다.
...
\resizebox{\textwidth}{!}{\input{tables/behavioral_model_improvements}}
\end{table}
...
3위에서 3.65\% 낮다. 선호 명세의 TV 중앙값은 쌍승에서 M-R 0.2664와
...
\resizebox{\textwidth}{!}{\input{tables/behavioral_time_forward}}
\end{table}
...
M-S3은 삼쌍승 98.9\%, 삼복승 96.5\%다. 특히 희박한 결합확률을 한 번에
